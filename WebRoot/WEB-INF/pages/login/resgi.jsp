...
<html lang="en">  
    ...
    <div id="register_dialog">  
        <div style="width: 300px;margin:10px auto;">  
			<form id="formsw" action="${basePath}/login/resig" method="post" onkeydown="if(event.keyCode==13)return false;">  
					<ul class="reg-box">
						<li>  
							<p>用户名</p>
			...
			<div class="sub">  
				<input type="button" class="c_button" value="立即注册" onclick="sublimer()"/> 
				<input type="submit" id="submittt" style="display:none;"> 
			</div>  
			<a href="${basePath}/login/index" class="changes">已有账号？点击登录</a>
		</form>  
      </div>  
    </div>
	<!--尾部-->
	...
	//设置按钮提交后不可用
   	...
   	function sublimer(){
   		if(nameflag && phoneflag && passflag && repassflag) $("#submittt").click();
   	}
